	...
	<div class="rap2">		
		<content> 
			...
			<c:if test="${UserVO.uname == BoCommentVO.uname}">
				<span style="float:right; margin:-22px 80px 0px 0px;">
					<a href="${path}/View2?bnum=${BoardVO.bnum}&conum=${BoCommentVO.conum}"><b>MODIFY</b></a>
				</span>
				<span style="float:right; margin:-22px 10px 0px 0px;">
					<a href="${path}/CommentsDelAction?bnum=${BoardVO.bnum}&conum=${BoCommentVO.conum}"><b>DELETE</b></a>
				</span>
			</c:if>
